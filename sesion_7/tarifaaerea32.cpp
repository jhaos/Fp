...
int main(){
	...
	cout << "Introduzca el caracter para añadir el bille ";
	cin >> nuevo_billete;

	}while (nuevo_billete != ENTRADA_CORRECTA);

	while (nuevo_billete == ENTRADA_CORRECTA || nuevo_billete != TERMINADOR){  	
	   ...
	   }while (kilometros <= MIN_KILOMETROS);
	
	   do{
	   	cout << "Introduzca num_puntos" << endl;
	      cin >> num_puntos;
	   ...
	   do{
	   	...
	   	cout << "introduzca otro billete " << endl;
	      cin >> nuevo_billete;
